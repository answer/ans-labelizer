...
module Ans
  module Labelizer
    ...
    included do
      define_flag_methods ::I18n.t("#{Labelizer.config.locale_path}.#{self.model_name.singular}", default: {})
    end

    class_methods do

      def define_flag_methods(flag_hash)
        label_class_name = "#{self.to_s.gsub("::","__")}AnsLabels".to_sym
